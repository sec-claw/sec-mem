...
from sec_mem.configs.base import MemoryConfig, MemoryItem
from sec_mem.configs.enums import MemoryType
from sec_mem.configs.prompts import (
    PROCEDURAL_MEMORY_SYSTEM_PROMPT,
    get_update_memory_messages,
)
from sec_mem.exceptions import ValidationError as Mem0ValidationError
from sec_mem.memory.base import MemoryBase
from sec_mem.memory.setup import sec_mem_dir, setup_config
from sec_mem.memory.storage import SQLiteManager
from sec_mem.memory.telemetry import MEM0_TELEMETRY, capture_event
from sec_mem.memory.utils import (
...
from sec_mem.utils.factory import (
    EmbedderFactory,
    GraphStoreFactory,
    LlmFactory,
    RerankerFactory,
...
class Memory(MemoryBase):
    def __init__(self, config: MemoryConfig = MemoryConfig()):
        ...
        if MEM0_TELEMETRY:
            ...
            telemetry_config_dict['collection_name'] = "sec_memmigrations"

            # Set path for file-based vector stores
            if self.config.vector_store.provider in ["faiss", "qdrant"]:
                provider_path = f"migrations_{self.config.vector_store.provider}"
                telemetry_config_dict['path'] = os.path.join(sec_mem_dir, provider_path)
        ...
        capture_event("sec_mem.init", self, {"sync_type": "sync"})
    ...
    def get(self, memory_id):
        ...
        """
        capture_event("sec_mem.get", self, {"memory_id": memory_id, "sync_type": "sync"})
    ...
    def get_all(
        ...
        *,
        ...
        capture_event(
            "sec_mem.get_all", self, {"limit": limit, "keys": keys, "encoded_ids": encoded_ids, "sync_type": "sync"}
        )
    ...
    def update(self, memory_id, data):
        ...
        """
        capture_event("sec_mem.update", self, {"memory_id": memory_id, "sync_type": "sync"})
    ...
    def delete(self, memory_id):
        ...
        """
        capture_event("sec_mem.delete", self, {"memory_id": memory_id, "sync_type": "sync"})
    ...
    def delete_all(self, user_id: Optional[str] = None, agent_id: Optional[str] = None, run_id: Optional[str] = None):
        ...
        keys, encoded_ids = process_telemetry_filters(filters)
        capture_event("sec_mem.delete_all", self, {"keys": keys, "encoded_ids": encoded_ids, "sync_type": "sync"})
    ...
    def history(self, memory_id):
        ...
        """
        capture_event("sec_mem.history", self, {"memory_id": memory_id, "sync_type": "sync"})
    ...
    def _create_procedural_memory(self, messages, metadata=None, prompt=None):
        ...
        capture_event("sec_mem._create_procedural_memory", self, {"memory_id": memory_id, "sync_type": "sync"})
    ...
    def reset(self):
        ...
        capture_event("sec_mem.reset", self, {"sync_type": "sync"})
...
class AsyncMemory(MemoryBase):
    def __init__(self, config: MemoryConfig = MemoryConfig()):
        ...
        if MEM0_TELEMETRY:
            ...
            telemetry_config.collection_name = "sec_memmigrations"
            if self.config.vector_store.provider in ["faiss", "qdrant"]:
                provider_path = f"migrations_{self.config.vector_store.provider}"
                telemetry_config.path = os.path.join(sec_mem_dir, provider_path)
                os.makedirs(telemetry_config.path, exist_ok=True)
            self._telemetry_vector_store = VectorStoreFactory.create(self.config.vector_store.provider, telemetry_config)
        capture_event("sec_mem.init", self, {"sync_type": "async"})
    ...
    async def get(self, memory_id):
        ...
        Returns:
            dict: Retrieved memory.
        """
        capture_event("sec_mem.get", self, {"memory_id": memory_id, "sync_type": "async"})
    ...
    async def get_all(
        ...
        *,
        ...
        keys, encoded_ids = process_telemetry_filters(effective_filters)
        capture_event(
            "sec_mem.get_all", self, {"limit": limit, "keys": keys, "encoded_ids": encoded_ids, "sync_type": "async"}
        )
    ...
    async def update(self, memory_id, data):
        ...
        Example:
            ...
            {'message': 'Memory updated successfully!'}
        """
        capture_event("sec_mem.update", self, {"memory_id": memory_id, "sync_type": "async"})
    ...
    async def delete(self, memory_id):
        ...
        Args:
            memory_id (str): ID of the memory to delete.
        """
        capture_event("sec_mem.delete", self, {"memory_id": memory_id, "sync_type": "async"})
    ...
    async def delete_all(self, user_id=None, agent_id=None, run_id=None):
        ...
        keys, encoded_ids = process_telemetry_filters(filters)
        capture_event("sec_mem.delete_all", self, {"keys": keys, "encoded_ids": encoded_ids, "sync_type": "async"})
    ...
    async def history(self, memory_id):
        ...
        Returns:
            list: List of changes for the memory.
        """
        capture_event("sec_mem.history", self, {"memory_id": memory_id, "sync_type": "async"})
    ...
    async def _create_procedural_memory(self, messages, metadata=None, llm=None, prompt=None):
        ...
        capture_event("sec_mem._create_procedural_memory", self, {"memory_id": memory_id, "sync_type": "async"})
    ...
    async def reset(self):
        ...
        capture_event("sec_mem.reset", self, {"sync_type": "async"})
