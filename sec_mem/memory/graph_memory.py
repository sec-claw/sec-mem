...
from sec_mem.memory.utils import format_entities, sanitize_relationship_for_cypher
...
from sec_mem.graphs.tools import (
...
from sec_mem.graphs.utils import EXTRACT_RELATIONS_PROMPT, get_delete_messages
from sec_mem.utils.factory import EmbedderFactory, LlmFactory
...
class MemoryGraph:
    ...
    def _delete_entities(self, to_be_deleted, filters):
        ...
        for item in to_be_deleted:
            ...
            # See: https://github.com/sec_memai/sec_mem/issues/4187
            cypher = f"""
